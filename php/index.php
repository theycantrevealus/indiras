...
<div class="container">
	<h4 class="page-header text-center">MENU</h4>
			...
			?>
				<div id="<?php echo $ftrow['catname']; ?>" class="tab-pane fade in active" style="margin-top:20px;">
					<?php
						...
						$sql="select * from product where categoryid='".$ftrow['categoryid']."' AND status=1";
			...
			while($trow=$cquery->fetch_array()){
				...
				<div id="<?php echo $trow['catname']; ?>" class="tab-pane fade" style="margin-top:20px;">
					<?php
						...
						$sql="select * from product where categoryid='".$trow['categoryid']."' AND status=1";
