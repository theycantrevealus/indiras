...
import { masterItemUnitConversionArray } from '@gateway_core/master/mock/master.item.unit.mock'
...
export const mockMasterItem = (
  ...
  unit_conversion = masterItemUnitConversionArray,
