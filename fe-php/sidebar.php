<aside class="left-sidebar with-vertical">
      <div><!-- ---------------------------------- -->
        ...
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="order-data.php" class="text-nowrap logo-img">
            <img src="./assets/images/logos/logo.jpeg" alt="Logo-light" width="100%" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="order-history.php" aria-expanded="false">
                <span>
        ...
        <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
          <div class="hstack gap-3">
            ...
            <div class="john-title">
              <h6 class="mb-0 fs-4 fw-semibold" id="pegawai_nama"></h6>
              <span class="fs-2" id="pegawai_jabatan"></span>
            </div>
